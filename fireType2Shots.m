        ...
        for i = 1:maxRows
            ...
            if (guessBoardAI(i,j,k) == 2)
                ...
                if (i-1 > 1 && guessBoardAI(i-1,j,k) == 2)
                    ...
                    while (i-topCounter >= 1 && guessBoardAI(i-topCounter,j,k) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                ...
                if (i+1 < maxRows && guessBoardAI(i+1,j,k) == 2)
                    ...
                    %only shoot up to the min ship length to not waste
                    %shots (in case boards are huge)
                    while (i+bottomCounter<= maxRows && guessBoardAI(i+bottomCounter,j,k) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                        %Block the location to avoid double-shooting
                ...
                if (j-1 > 1 && guessBoardAI(i,j-1,k) == 2)
                    ...
                    %only shoot up to the min ship length to not waste
                    %shots (in case boards are huge)
                    while (j-leftCounter >= 1 && guessBoardAI(i,j-leftCounter,k) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                        %Block the location to avoid double-shooting
                ...
                if (j+1 < maxCols && guessBoardAI(i,j+1,k) == 2)
                    ...
                    %only shoot up to the min ship length to not waste
                    %shots (in case boards are huge)
                    while (j+rightCounter<= maxCols && guessBoardAI(i,j+rightCounter,k) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                        %Block the location to avoid double-shooting
                ...
                if (k-1 > 1 && guessBoardAI(i,j,k-1) == 2)
                    ...
                    %only shoot up to the min ship length to not waste
                    %shots (in case boards are huge)
                    while (k-outerCounter >= 1 && guessBoardAI(i,j,k-outerCounter) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                        %Block the location to avoid double-shooting
                ...
                if (k+1 < maxSheets && guessBoardAI(i,j,k+1) == 2)
                    ...
                    %only shoot up to the min ship length to not waste
                    %shots (in case boards are huge)
                    while (k+innerCounter<= maxSheets && guessBoardAI(i,j,k+innerCounter) == 0 && nShotsLeft > 0 && shotsFiredCounter <= minShipLength-1)
                        %Block the location to avoid double-shooting
